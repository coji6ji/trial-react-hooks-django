...
const Ask = ({ask, profile}) => {
  const classes = useStyles()
  Modal.setAppElement('#root')
  const {approveFriendRequest, sendDirectMessage} = useContext(ApiContext)
  ...
  const changeApproval = () => {
    ...
    approveFriendRequest(uploadDataAsk, ask)
  }
